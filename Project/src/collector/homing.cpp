...
#define DISTANCE_CORRECTION_FACTOR    1.5
...
/*
    ...
    delay(1000);
    double angular_l =
            ((double) encoders.getCountsLeft()) * 1000.0 * 60.0 * 0.10472 / (1000 * 909.7);
    double angular_r =
            ((double) encoders.getCountsRight()) * 1000.0 * 60.0 * 0.10472 / (1000 * 909.7);
